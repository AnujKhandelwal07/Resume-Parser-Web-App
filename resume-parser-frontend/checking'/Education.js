...
const Education = () => {
  ...
  const handleNext = async () => {
    ...
    if (!storedEducation.length) {
      alert("Please add at least one education entry before proceeding.");
      return;
    }
      ...
      {education.length > 0 && (
        ...
        >
          <Table sx={{ minWidth: 650 }}>
            <TableHead>
              <TableRow>
                <TableCell sx={{ width: "15%", backgroundColor: "#89CFF0" }}>
                  <b>Status</b>
                </TableCell>
                <TableCell sx={{ width: "15%", backgroundColor: "#89CFF0" }}>
                  <b>Degree</b>
            ...
            <TableBody>
              {education.map((edu, index) => (
                <TableRow key={index}>
                  <TableCell>
                    {edu.degree ? "Complete" : "Incomplete"}
                  </TableCell>
