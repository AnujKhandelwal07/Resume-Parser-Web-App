...
const Education = () => {
  ...
  // Auto-populate fields when parsed resume data is available
  // useEffect(() => {
  //   if (parsedData?.education?.length > 0) {
  //     setFormData((prevData) => ({
  //       ...prevData,
  //       ...parsedData.education[0], // Populate first education entry
  //     }));
  //   }

  //   if (parsedData?.specialties?.length > 0) {
  //     setFormData((prevData) => ({
  //       ...prevData,
  //       ...parsedData.specialties[0], // Populate first specialty entry
  //     }));
  //   }
  // }, [parsedData]);
  ...
  // useEffect(() => {
  //   if (parsedData?.education?.length > 0) {
  //     dispatch(setEducationData(parsedData.education)); // Load all education entries
  //   }
  // }, [parsedData, dispatch]);
  ...
  //   const storedEducation = sessionStorage.getItem("educationData");
  //   if (storedEducation) {
  //     dispatch(setResumeData({ education: JSON.parse(storedEducation) }));
  //   }

  //   const storedSpecialties = sessionStorage.getItem("specialtiesData");
  //   if (storedSpecialties) {
  //     const parsedSpecialties = JSON.parse(storedSpecialties)[0] || {}; //  first element in the array is undefined or null
  //     setFormData((prevData) => ({
  //       ...prevData,
  //       ...parsedSpecialties, // Merge specialties back into formData
  //     }));
  //   }
  // }, [dispatch]);
  ...
  //   setEditIndex(index); // track which education entry the user is updating
  ...
  //   // Check if specialties are filled but no complete education exists
  //   const hasIncompleteEducation =
  //     !storedEducation.length ||
  //     storedEducation.some((edu) => {
  //       return (
  //         !edu.school ||
  //         !edu.city ||
  //         !edu.state ||
  ...
  //   if (specialtiesFilled && hasIncompleteEducation) {
  //     alert("Please complete at least one education entry before proceeding.");
  //     return;
  //   }
  ...
  //     // Convert graduationDate to DateTime format
